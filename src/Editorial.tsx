    ...
    return (
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Handgemachte Illustrationen für Editorial und Kinderbücher - Aus Ladbergen (Germany)."
                />
                <meta
                    name="keywords"
                    content="Illustration, Kinderbücher, Editorial, Ladbergen, Münster, Osnabrück"
                />
                <meta
                    name="image"
