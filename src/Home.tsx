    ...
    <>
      ...
      <div className="md:col-start-2 md:col-span-1 text-lg tracking-wider">
        ...
        <p>
          ...
          Leidenschaften und zwar Grafikdesign, Fotografie und Illustration. In
          diesen Bereichen experimentiere ich gerne mit handgemachten Collagen,
          Illustrationen, Schriften, Fotos und alles, was man kombinieren kann.
          Ich schärfe auf diesem Wege ebenfalls meine Intuition für das
