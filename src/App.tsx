...
function App() {
  return (
    <div className="App grid h-screen">
      ...
      <main className="grid gap-16 p-4 md:p-0">
        <h1 className="absolute bottom-8 opacity-20 tracking-wider break-all font-serif text-8xl ml-16 transition-filter duration-300 hover:blur">Grafikdesign &amp; Illustration</h1>
      ...
      <footer className="flex justify-center p-4 z-10">
        <a className="mx-4 transition-opacity duration-300 hover:opacity-50"
