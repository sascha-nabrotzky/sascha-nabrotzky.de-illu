    ...
    en: {
      ...
      pages: {
        illustration: {
          ...
          text1:
            "I am an illustrator from Ladbergen (Germany) and have specialized in creating illustrations for websites, children's books and editorial with my unique style with pens, watercolors and ink.",
          text2:
            "Storytelling is very important to me, which is why I illustrate the characters in different poses and then place them in the desired environment. This creates a story that captivates the readers.",
        },
        childrensBooks: {
