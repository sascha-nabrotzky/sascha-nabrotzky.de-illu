        ...
        de: {
            ...
            pages: {
                ...
                childrensBooks: {
                    ...
                    text1a: "entstand ein Großprojekt und jetzt sind schon drei Kinderbücher von mir privat illustriert worden. Am Anfang stand das <strong>Characterdesign </strong> der Hauptfiguren und ein <strong>Farbschema</strong> wurde ausgearbeitet. Die <strong>Skizzen </strong> wurden eingescannt und digital weiterverarbeitet, um Farben und Hintergründe besser anpassen zu können.",
                    text1b: "Für das vierte Buch, habe ich die drei vorherigen komplett überarbeitet und die verschiedenen Zeichenstile so gut es geht angeglichen. Alle Seiten enthalten doppleseitige Illustrationen.",

                    title2: "Charakterdesign",
                    text2: "Seit dem zweiten Kinderbuch habe ich gemerkt, wie sehr eine Geschichte von dem Storytelling und den Charakteren lebt, also habe ich für mein viertes Buch die Charaktere noch einmal komplett überarbeitet und die verschiedenen Zeichenstile so gut es geht angeglichen.",
                    title3: "Digitale Arbeitsweise",
                    text3: "Wenn es darauf ankommt und speziell bei meinen Kinderbüchern arbeite ich von Anfang an digital, denn nur so kann ich leichter Korrekturen durchführen, wenn noch etwas auffallen sollte. Für den Druck der Bücher muss ich eh alles digital vorliegen haben und ich spare mir die Übertragung aus dem Analogen.",
                    book1: {
        ...
        en: {
            ...
            pages: {
                ...
                childrensBooks: {
                    ...
                    text1a: "a major project emerged and now three children's books have already been illustrated by me privately. At the beginning there was the <strong>character design</strong> of the main characters and a <strong>color scheme</strong> was developed. The <strong>sketches</strong> were scanned and digitally processed in order to be able to better adapt colors and backgrounds.",
                    text1b: "For the fourth book, I completely revised the previous three and tried to match the different drawing styles as well as possible. All pages contain double-page illustrations.",

                    title2: "Character design",
                    text2: "Since the second children's book, I have noticed how much a story lives from the storytelling and the characters, so for my fourth book I completely revised the characters again and tried to match the different drawing styles as well as possible.",
                    title3: "Digital workflow",
                    text3: "When it matters and especially with my children's books, I work digitally from the start, because that's the only way I can make corrections more easily if something else should be noticed. For printing the books, I have to have everything digitally anyway and I save myself the transfer from analog.",
                    book1: {
