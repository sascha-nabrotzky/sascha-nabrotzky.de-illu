        ...
        <MainLayout>
            <div className="md:col-start-2 md:col-span-1 max-md:px-4 text-lg tracking-wider">
                ...
                <p className="mt-4">
                    ...
                    Stellenwert für den Illustrator Sascha Nabrotzky. Eine
                    Nutzung der Internetseiten von Illustrator Sascha Nabrotzky
                    ist grundsätzlich ohne jede Angabe personenbezogener Daten
                    möglich. Sofern eine betroffene Person besondere Services
                    unseres Unternehmens über unsere Internetseite in Anspruch
                    nehmen möchte, könnte jedoch eine Verarbeitung
                    personenbezogener Daten erforderlich werden. Ist die
                    Verarbeitung personenbezogener Daten erforderlich und
                ...
                <p className="mt-4">
                    ...
                    für Illustrator Sascha Nabrotzky geltenden
                    ...
                    erhobenen, genutzten und verarbeiteten personenbezogenen
                    Daten informieren. Ferner werden betroffene Personen mittels
                    dieser Datenschutzerklärung über die ihnen zustehenden
                    Rechte aufgeklärt.
                </p>

                <p className="mt-4">
                    Illustrator Sascha Nabrotzky hat als für die Verarbeitung
                    Verantwortlicher zahlreiche technische und organisatorische
                    Maßnahmen umgesetzt, um einen möglichst lückenlosen Schutz
                    der über diese Internetseite verarbeiteten personenbezogenen
                ...
                <h4 className="mt-4">1. Begriffsbestimmungen</h4>
                <p className="mt-4">
                    Die Datenschutzerklärung von Illustrator Sascha Nabrotzky
                ...
                <ul>
                    <li>
                        <h4 className="mt-4">a. personenbezogene Daten</h4>
                        <p className="mt-4">
                    ...
                    <li>
                        <h4 className="mt-4">b. betroffene Person</h4>
                        <p className="mt-4">
                    ...
                    <li>
                        <h4 className="mt-4">c. Verarbeitung</h4>
                        <p className="mt-4">
                    ...
                    <li>
                        <h4 className="mt-4">e. Profiling</h4>
                        <p className="mt-4">
                    ...
                    <li>
                        <h4 className="mt-4">f. Pseudonymisierung</h4>
                        <p className="mt-4">
                    ...
                    <li>
                        ...
                        <p className="mt-4">
                            ...
                            allein oder gemeinsam mit anderen über die Zwecke
                    ...
                    <li>
                        <h4 className="mt-4">h. Auftragsverarbeiter</h4>
                        <p className="mt-4">
                    ...
                    <li>
                        <h4 className="mt-4">i. Empfänger</h4>
                        <p className="mt-4">
                    ...
                    <li>
                        <h4 className="mt-4">j. Dritter</h4>
                        <p className="mt-4">
                    ...
                    <li>
                        <h4 className="mt-4">k. Einwilligung</h4>
                        <p className="mt-4">
                ...
                <p className="mt-4"> Illustrator Sascha Nabrotzky</p>
                <p className="mt-4">Koldefeld, 11</p>
                <p className="mt-4">49549 Ladbergen</p>
                <p className="mt-4">Deutschland</p>
                <p className="mt-4">Tel.: 05485207979</p>
                <p className="mt-4">
                    E-Mail: sascha.nabrotzky (at) online (.de)
                </p>
                <p className="mt-4">Website: sascha-nabrotzky.de</p>

                <h4 className="mt-4">
                    3. Erfassung von allgemeinen Daten und Informationen
                </h4>
                <p className="mt-4">
                    Die Internetseite des Illustrators Sascha Nabrotzky erfasst
                    mit jedem Aufruf der Internetseite durch eine betroffene
                    Person oder ein automatisiertes System eine Reihe von
                    allgemeinen Daten und Informationen. Diese allgemeinen Daten
                    und Informationen werden in den Logfiles des Servers
                    gespeichert. Erfasst werden können die (1) verwendeten
                    Browsertypen und Versionen, (2) das vom zugreifenden System
                    verwendete Betriebssystem, (3) die Internetseite, von
                    welcher ein zugreifendes System auf unsere Internetseite
                    gelangt (sogenannte Referrer), (4) die Unterwebseiten,
                    welche über ein zugreifendes System auf unserer
                ...
                <p className="mt-4">
                    ...
                    zieht die Illustrator Sascha Nabrotzky keine Rückschlüsse
                    auf die betroffene Person. Diese Informationen werden
                    vielmehr benötigt, um (1) die Inhalte unserer Internetseite
                    korrekt auszuliefern, (2) die Inhalte unserer Internetseite
                    sowie die Werbung für diese zu optimieren, (3) die
                    ...
                    Informationen werden durch die Illustrator Sascha Nabrotzky
                ...
                <h4 className="mt-4">E-Mail-Kontakt / mailto-Links</h4>
                <p className="mt-4">
                    Auf der Website von Frontent-Entwickler Sascha Nabrotzky ist
                    kein Kontaktformular vorhanden. Besucher können über einen
                    mailto-Link auf der Webseite Nachrichten an ihn übermitteln.
                    Um eine Antwort empfangen zu können, ist zumindest die
                    Angabe einer gültigen E-Mail-Adresse erforderlich. Alle
                    weiteren Angaben kann die anfragende Person freiwillig
                    geben. Mit Absenden der Nachricht über den jeweiligen
                    E-Mail-Client willigt der Besucher in die Verarbeitung der
                    übermittelten personenbezogenen Daten ein.
                </p>

                <p className="mt-4">
                    Die Datenverarbeitung erfolgt ausschließlich zu dem Zweck
                    der Abwicklung und Beantwortung von Anfragen über den
                    mailto-Link. Dies geschieht auf Basis der freiwillig
                    erteilten Einwilligung gem. Art. 6 Abs. 1 Satz 1 Buchst. a.
                    DSGVO. Die für die Benutzung des mailto-Links erhobenen
                    personenbezogenen Daten werden automatisch gelöscht, sobald
                ...
                <h4 className="mt-4">5. Rechte der betroffenen Person</h4>
                <ul>
                    <li>
                        <h4 className="mt-4">a. Recht auf Bestätigung</h4>
                        <p className="mt-4">
                            Jede betroffene Person hat das vom Europäischen
                            Richtlinien- und Verordnungsgeber eingeräumte Recht,
                            von dem für die Verarbeitung Verantwortlichen eine
                    ...
                    <li>
                        <h4 className="mt-4">b. Recht auf Auskunft</h4>
                        <p className="mt-4">
                            Jede von der Verarbeitung personenbezogener Daten
                            betroffene Person hat das vom Europäischen
                            Richtlinien- und Verordnungsgeber gewährte Recht,
                            jederzeit von dem für die Verarbeitung
                            Verantwortlichen unentgeltliche Auskunft über die zu
                            seiner Person gespeicherten personenbezogenen Daten
                            und eine Kopie dieser Auskunft zu erhalten. Ferner
                            hat der Europäische Richtlinien- und
                            Verordnungsgeber der betroffenen Person Auskunft
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                Daten oder auf Einschränkung der Verarbeitung
                            ...
                            <li>
                                ...
                                gemäß Artikel 22 Abs.1 und 4 DS-GVO und —
                                zumindest in diesen Fällen — aussagekräftige
                                Informationen über die involvierte Logik sowie
                                die Tragweite und die angestrebten Auswirkungen
                                einer derartigen Verarbeitung für die betroffene
                                Person
                            </li>
                        </ul>
                        <p className="mt-4">
                            Ferner steht der betroffenen Person ein
                            Auskunftsrecht darüber zu, ob personenbezogene Daten
                            an ein Drittland oder an eine internationale
                            Organisation übermittelt wurden. Sofern dies der
                            Fall ist, so steht der betroffenen Person im Übrigen
                            das Recht zu, Auskunft über die geeigneten Garantien
                            im Zusammenhang mit der Übermittlung zu erhalten.
                        </p>

                        <p className="mt-4">
                            Möchte eine betroffene Person dieses Auskunftsrecht
                    ...
                    <li>
                        <h4 className="mt-4">c. Recht auf Berichtigung</h4>
                        <p className="mt-4">
                            Jede von der Verarbeitung personenbezogener Daten
                            betroffene Person hat das vom Europäischen
                            Richtlinien- und Verordnungsgeber gewährte Recht,
                            die unverzügliche Berichtigung sie betreffender
                            unrichtiger personenbezogener Daten zu verlangen.
                            Ferner steht der betroffenen Person das Recht zu,
                            unter Berücksichtigung der Zwecke der Verarbeitung,
                            die Vervollständigung unvollständiger
                        ...
                        <p className="mt-4">
                            ...
                            Berichtigungsrecht in Anspruch nehmen, kann sie sich
                    ...
                    <li>
                        ...
                        <p className="mt-4">
                            ...
                            betroffene Person hat das vom Europäischen
                            Richtlinien- und Verordnungsgeber gewährte Recht,
                            von dem Verantwortlichen zu verlangen, dass die sie
                        ...
                        <ul>
                            <li>
                                ...
                                Zwecke erhoben oder auf sonstige Weise
                                verarbeitet, für welche sie nicht mehr notwendig
                                sind.
                            </li>
                            <li>
                                Die betroffene Person widerruft ihre
                                Einwilligung, auf die sich die Verarbeitung
                                gemäß Art. 6 Abs. 1 Buchstabe a DS-GVO oder Art.
                                9 Abs. 2 Buchstabe a DS-GVO stützte, und es
                                fehlt an einer anderweitigen Rechtsgrundlage für
                                die Verarbeitung.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                dem Unionsrecht oder dem Recht der
                        ...
                        <p className="mt-4">
                            ...
                            eine betroffene Person die Löschung von
                            personenbezogenen Daten, die bei der Illustrator
                            Sascha Nabrotzky gespeichert sind, veranlassen
                            möchte, kann sie sich hierzu jederzeit an einen
                            Mitarbeiter des für die Verarbeitung
                            Verantwortlichen wenden. Der Mitarbeiter der
                            Illustrator Sascha Nabrotzky wird veranlassen, dass
                            dem Löschverlangen unverzüglich nachgekommen wird.
                        </p>

                        <p className="mt-4">
                            Wurden die personenbezogenen Daten von der
                            Illustrator Sascha Nabrotzky öffentlich gemacht und
                            ist unser Unternehmen als Verantwortlicher gemäß
                            Art. 17 Abs. 1 DS-GVO zur Löschung der
                            personenbezogenen Daten verpflichtet, so trifft die
                            Illustrator Sascha Nabrotzky unter Berücksichtigung
                            ...
                            verlangt hat, soweit die Verarbeitung nicht
                            erforderlich ist. Der Mitarbeiter der Illustrator
                            Sascha Nabrotzky wird im Einzelfall das Notwendige
                            veranlassen.
                        </p>
                    </li>
                    <li>
                        ...
                        <p className="mt-4">
                            ...
                            betroffene Person hat das vom Europäischen
                            Richtlinien- und Verordnungsgeber gewährte Recht,
                            von dem Verantwortlichen die Einschränkung der
                        ...
                        <ul>
                            <li>
                                ...
                                von der betroffenen Person bestritten, und zwar
                        ...
                        <p className="mt-4">
                            ...
                            gegeben ist und eine betroffene Person die
                            Einschränkung von personenbezogenen Daten, die bei
                            der Illustrator Sascha Nabrotzky gespeichert sind,
                            verlangen möchte, kann sie sich hierzu jederzeit an
                            einen Mitarbeiter des für die Verarbeitung
                            Verantwortlichen wenden. Der Mitarbeiter der
                            Illustrator Sascha Nabrotzky wird die Einschränkung
                    ...
                    <li>
                        ...
                        <p className="mt-4">
                            ...
                            betroffene Person hat das vom Europäischen
                            Richtlinien- und Verordnungsgeber gewährte Recht,
                            die sie betreffenden personenbezogenen Daten, welche
                            ...
                            Verarbeitung auf der Einwilligung gemäß Art. 6 Abs.
                            1 Buchstabe a DS-GVO oder Art. 9 Abs. 2 Buchstabe a
                            DS-GVO oder auf einem Vertrag gemäß Art. 6 Abs. 1
                            Buchstabe b DS-GVO beruht und die Verarbeitung
                            mithilfe automatisierter Verfahren erfolgt, sofern
                            die Verarbeitung nicht für die Wahrnehmung einer
                        ...
                        <p className="mt-4">
                            ...
                            ihres Rechts auf Datenübertragbarkeit gemäß Art. 20
                        ...
                        <p className="mt-4">
                            ...
                            jederzeit an einen Mitarbeiter der Illustrator
                            Sascha Nabrotzky wenden.
                        </p>
                    </li>
                    <li>
                        <h4 className="mt-4">g. Recht auf Widerspruch</h4>
                        <p className="mt-4">
                            Jede von der Verarbeitung personenbezogener Daten
                            betroffene Person hat das vom Europäischen
                            Richtlinien- und Verordnungsgeber gewährte Recht,
                            aus Gründen, die sich aus ihrer besonderen Situation
                            ergeben, jederzeit gegen die Verarbeitung sie
                            betreffender personenbezogener Daten, die aufgrund
                        ...
                        <p className="mt-4">
                            Die Illustrator Sascha Nabrotzky verarbeitet die
                            ...
                            nachweisen, die den Interessen, Rechten und
                        ...
                        <p className="mt-4">
                            Verarbeitet die Illustrator Sascha Nabrotzky
                            personenbezogene Daten, um Direktwerbung zu
                            betreiben, so hat die betroffene Person das Recht,
                            ...
                            Verbindung steht. Widerspricht die betroffene Person
                            gegenüber der Illustrator Sascha Nabrotzky der
                            Verarbeitung für Zwecke der Direktwerbung, so wird
                            die Illustrator Sascha Nabrotzky die
                        ...
                        <p className="mt-4">
                            ...
                            personenbezogener Daten, die bei der Illustrator
                            Sascha Nabrotzky zu wissenschaftlichen oder
                            historischen Forschungszwecken oder zu statistischen
                            Zwecken gemäß Art. 89 Abs. 1 DS-GVO erfolgen,
                        ...
                        <p className="mt-4">
                            ...
                            die betroffene Person direkt an jeden Mitarbeiter
                            der Illustrator Sascha Nabrotzky oder einen anderen
                            Mitarbeiter wenden. Der betroffenen Person steht es
                            ferner frei, im Zusammenhang mit der Nutzung von
                            Diensten der Informationsgesellschaft, ungeachtet
                    ...
                    <li>
                        ...
                        <p className="mt-4">
                            ...
                            oder (2) aufgrund von Rechtsvorschriften der Union
                            ...
                            der Rechte und Freiheiten sowie der berechtigten
                            Interessen der betroffenen Person enthalten oder (3)
                        ...
                        <p className="mt-4">
                            ...
                            (2) erfolgt sie mit ausdrücklicher Einwilligung der
                            betroffenen Person, trifft die Illustrator Sascha
                            Nabrotzky angemessene Maßnahmen, um die Rechte und
                    ...
                    <li>
                        ...
                        <p className="mt-4">
                            ...
                            betroffene Person hat das vom Europäischen
                            Richtlinien- und Verordnungsgeber gewährte Recht,
                            eine Einwilligung zur Verarbeitung personenbezogener
                            Daten jederzeit zu widerrufen.
                        </p>

                        <p className="mt-4">
                            Möchte die betroffene Person ihr Recht auf Widerruf
                            einer Einwilligung geltend machen, kann sie sich
                            hierzu jederzeit an einen Mitarbeiter des für die
                            Verarbeitung Verantwortlichen wenden.
                        </p>
                    </li>
                </ul>
                <h4 className="mt-4">6. Rechtsgrundlage der Verarbeitung</h4>
                <p className="mt-4">
                ...
                <h4 className="mt-4">
                    8. Dauer, für die die personenbezogenen Daten gespeichert
                    werden
                </h4>
                <p className="mt-4">
                ...
                <p className="mt-4">
                    Als verantwortungsbewusstes Unternehmen verzichten ich auf
