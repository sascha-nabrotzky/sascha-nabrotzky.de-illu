...
const Datenschutz = () => {
  ...
  Illustrator Sascha Nabrotzky. Eine Nutzung der Internetseiten
  von  Illustrator Sascha Nabrotzky ist grundsätzlich ohne jede
  ...
  und in Übereinstimmung mit den für  Illustrator Sascha
  ...
  folgenden Begriffe:
      ...
      der sie betreffenden personenbezogenen Daten einverstanden ist.
            ...
            <h4 className="mt-4">2. Name und Anschrift des für die Verarbeitung Verantwortlichen</h4>
            <p className="mt-4">
  ...
  Charakter ist die:
            ...
            <h4 className="mt-4">3. Erfassung von allgemeinen Daten und Informationen</h4>
            <p className="mt-4">
  Die Internetseite des Illustrators Sascha Nabrotzky erfasst mit
  ...
  Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die
   Illustrator Sascha Nabrotzky keine Rückschlüsse auf die
  ...
  Vorschriften gesperrt oder gelöscht.
      ...
      Mitarbeiter des für die Verarbeitung Verantwortlichen wenden.
                ...
                <li>
                    <h4 className="mt-4">d. Recht auf Löschung (Recht auf Vergessen werden)</h4>
                    <p className="mt-4">
      Jede von der Verarbeitung personenbezogener Daten betroffene
      Person hat das vom Europäischen Richtlinien- und Verordnungsgeber
      ...
      bei der  Illustrator Sascha Nabrotzky gespeichert sind,
      ...
      Mitarbeiter der  Illustrator Sascha Nabrotzky wird
      veranlassen, dass dem Löschverlangen unverzüglich nachgekommen
      wird.
                    </p>

                    <p className="mt-4">
      Wurden die personenbezogenen Daten von der  Illustrator
      ...
      personenbezogenen Daten verpflichtet, so trifft die
       Illustrator Sascha Nabrotzky unter Berücksichtigung der
      ...
      die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der
       Illustrator Sascha Nabrotzky wird im Einzelfall das
      Notwendige veranlassen.
                    </p>
                </li>
                <li>
                    <h4 className="mt-4">e. Recht auf Einschränkung der Verarbeitung</h4>
                    <p className="mt-4">
      Jede von der Verarbeitung personenbezogener Daten betroffene
      Person hat das vom Europäischen Richtlinien- und Verordnungsgeber
      ...
      Daten, die bei der  Illustrator Sascha Nabrotzky
      ...
      wenden. Der Mitarbeiter der  Illustrator Sascha Nabrotzky
      ...
      betroffene Person gegenüber der  Illustrator Sascha
      Nabrotzky der Verarbeitung für Zwecke der Direktwerbung, so wird
      die  Illustrator Sascha Nabrotzky die personenbezogenen
      ...
      Verarbeitung personenbezogener Daten, die bei der
       Illustrator Sascha Nabrotzky zu wissenschaftlichen oder
      ...
      ausdrücklicher Einwilligung der betroffenen Person, trifft die
       Illustrator Sascha Nabrotzky angemessene Maßnahmen, um die
  ...
  Nichtbereitstellung der personenbezogenen Daten hätte.
            ...
            <h4 className="mt-4">10. Bestehen einer automatisierten Entscheidungsfindung</h4>
            <p className="mt-4">
