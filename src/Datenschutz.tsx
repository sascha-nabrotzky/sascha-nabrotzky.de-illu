    ...
    <MainLayout>
      <div className="md:col-start-2 md:col-span-1 max-md:px-4 text-lg tracking-wider">
        ...
        <p className="mt-4">
          ...
          Datenschutz hat einen besonders hohen Stellenwert für den Illustrator
          Sascha Nabrotzky. Eine Nutzung der Internetseiten von Illustrator
          Sascha Nabrotzky ist grundsätzlich ohne jede Angabe personenbezogener
        ...
        <p className="mt-4">
          ...
          und in Übereinstimmung mit den für Illustrator Sascha Nabrotzky
        ...
        <p className="mt-4">
          Die Datenschutzerklärung von Illustrator Sascha Nabrotzky beruht auf
        ...
        <ul>
          ...
          <li>
            <h4 className="mt-4">d. Einschränkung der Verarbeitung</h4>
            <p className="mt-4">
        ...
        <p className="mt-4">E-Mail: sascha.nabrotzky (at) online (.de)</p>
        ...
        <p className="mt-4">
          Die Internetseite des Illustrators Sascha Nabrotzky erfasst mit jedem
        ...
        <p className="mt-4">
          ...
          Illustrator Sascha Nabrotzky keine Rückschlüsse auf die betroffene
          ...
          anonym erhobenen Daten und Informationen werden durch die Illustrator
          Sascha Nabrotzky daher einerseits statistisch und ferner mit dem Ziel
        ...
        <ul>
          ...
          <li>
            ...
            <p className="mt-4">
              ...
              bei der Illustrator Sascha Nabrotzky gespeichert sind, veranlassen
              ...
              Illustrator Sascha Nabrotzky wird veranlassen, dass dem
              Löschverlangen unverzüglich nachgekommen wird.
            </p>

            <p className="mt-4">
              Wurden die personenbezogenen Daten von der Illustrator Sascha
              Nabrotzky öffentlich gemacht und ist unser Unternehmen als
              Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
              personenbezogenen Daten verpflichtet, so trifft die Illustrator
              Sascha Nabrotzky unter Berücksichtigung der verfügbaren
              ...
              nicht erforderlich ist. Der Mitarbeiter der Illustrator Sascha
              Nabrotzky wird im Einzelfall das Notwendige veranlassen.
            </p>
          </li>
          <li>
            <h4 className="mt-4">
            ...
            <p className="mt-4">
              ...
              Daten, die bei der Illustrator Sascha Nabrotzky gespeichert sind,
              verlangen möchte, kann sie sich hierzu jederzeit an einen
              Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
              Mitarbeiter der Illustrator Sascha Nabrotzky wird die
              Einschränkung der Verarbeitung veranlassen.
            </p>
          </li>
          <li>
            <h4 className="mt-4">f. Recht auf Datenübertragbarkeit</h4>
            <p className="mt-4">
              Jede von der Verarbeitung personenbezogener Daten betroffene
              Person hat das vom Europäischen Richtlinien- und Verordnungsgeber
            ...
            <p className="mt-4">
              ...
              Illustrator Sascha Nabrotzky wenden.
            </p>
          </li>
          <li>
            ...
            <p className="mt-4">
              Die Illustrator Sascha Nabrotzky verarbeitet die personenbezogenen
            ...
            <p className="mt-4">
              Verarbeitet die Illustrator Sascha Nabrotzky personenbezogene
              ...
              Person gegenüber der Illustrator Sascha Nabrotzky der Verarbeitung
              für Zwecke der Direktwerbung, so wird die Illustrator Sascha
            ...
            <p className="mt-4">
              ...
              Verarbeitung personenbezogener Daten, die bei der Illustrator
              Sascha Nabrotzky zu wissenschaftlichen oder historischen
            ...
            <p className="mt-4">
              ...
              Person direkt an jeden Mitarbeiter der Illustrator Sascha
          ...
          <li>
            ...
            <p className="mt-4">
              ...
              Illustrator Sascha Nabrotzky angemessene Maßnahmen, um die Rechte
        ...
        <p className="mt-4">
          Als verantwortungsbewusstes Unternehmen verzichten ich auf eine
